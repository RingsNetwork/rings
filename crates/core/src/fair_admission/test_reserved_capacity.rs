...
#[test]
fn test_admissible_capacity_preserves_every_other_class_reservation() {
...
#[test]
fn test_invalid_release_keeps_aggregate_and_class_totals_equal() {
...
#[test]
fn test_valid_release_preserves_capacity_sum_invariant() {
    let mut capacity = ReservedCapacity::<2>::new();
