...
#[test]
fn all_short_traces_preserve_fifo_cancellation_and_shutdown_invariants() {
...
#[test]
fn sustained_mixed_load_bounds_control_and_rotates_lower_service() {
...
#[test]
fn fourth_control_frame_is_followed_by_waiting_lower_work() {
    let mut queue = TransferQueues::default();
    for id in 0..5 {
        queue.push(TransferClass::DhtControl, id);
    }
