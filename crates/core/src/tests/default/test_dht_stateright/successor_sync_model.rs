...
//!
//! Token and effect flow:
//!
//! ```text
//! begin(reporter, request)
//!           |
//!           v
//! claim exact current token
//!           |
//!           v
...
/// Prove successor-sync tokens are exact, single-use, and effect bounded.
///
/// Superseded identities cannot be claimed, a current identity can be claimed
/// once, invalidation stops its plan, and one report cannot exceed successor capacity.
#[test]
