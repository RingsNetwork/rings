//! Module for load r1cs and witness
//! ================
...
//!   - refine the original work here: <https://github.com/lurk-lab/circom-scotia>
...
/// Represents the JSON structure of a Circuit.
/// This struct is used for deserializing the JSON representation of a circuit into a Rust data structure.
...
/// Represents the header of an R1CS file.
/// Contains metadata about the R1CS file, such as the size of the field, number of wires, and constraints.
#[allow(dead_code)]
...
/// Represents the content of an R1CS file.
/// Encapsulates the data read from an R1CS file, including the version, header information, constraints, and wire mapping.
#[allow(dead_code)]
#[derive(Debug, Default)]
...
pub fn load_witness_from_bin_reader<Fr: PrimeField, R: Read>(mut reader: R) -> Result<Vec<Fr>> {
    ...
    // if prime != hex!("010000f093f5e1439170b97948e833285d588181b64550b829a031e1724e6430".to_string()) {
    //     return Error::LoadR1CS("invalid curve prime {:?}", prime);
    // }
...
fn from_reader<Fr: PrimeField, R: Read + Seek>(mut reader: R) -> Result<R1CSFile<Fr>> {
    ...
    // if header.prime_size != hex!("010000f093f5e1439170b97948e833285d588181b64550b829a031e1724e6430".to_string()) {
