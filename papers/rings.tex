...
\[
\begin{array}{rcl}
\vec{T}&=&(T_{conn},T_{hop},T_{crypto},T_{app},T_{witness}),\\
\mathsf{PerfClaim}_{R}&\Rightarrow&\mathsf{Measure}_{build}(\vec{T}),\\
\mathsf{Baseline}_{C}&=&\mathsf{hop/churn}.
\end{array}
\]
Chord remains the overlay baseline~\cite{Chord}; Rings performance requires
Rings-specific measurements.
